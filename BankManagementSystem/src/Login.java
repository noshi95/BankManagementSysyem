...
public class Login extends JFrame {
	...
	{	
		...
		setContentPane(new JLabel(new ImageIcon("C:\\Users\\Uchchhwash\\workspace\\Java Project\\src\\img1.jpg")));
		setResizable(true);
		setVisible(true);
		...
		txtLoginInfo.setFont(new Font("Tahoma", Font.BOLD, 30));
		txtLoginInfo.setBounds(185, 0, 452, 62);
		add(txtLoginInfo);
			...
			public void actionPerformed(ActionEvent e1) {
				try
				{
					...
					if(count==1)
						...
						{
							JOptionPane.showMessageDialog(null,"Dupclicate UserName and Password");
						}
