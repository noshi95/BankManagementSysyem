...
public class ForgetPassword extends JFrame 
{
	...
	public ForgetPassword()
	{
		...
		setContentPane(new JLabel(new ImageIcon("C:\\Users\\Uchchhwash\\workspace\\Java Project\\src\\Img6cr600.jpg")));
		...
		labelChangePass.setFont(new Font("Calibri",Font.BOLD,20));
			...
			public void actionPerformed(ActionEvent e1) 
			{
				...
				{	
					...
					try {
						...
						String query1 ="update user set Password=? where Username= '"+userName+"'";
