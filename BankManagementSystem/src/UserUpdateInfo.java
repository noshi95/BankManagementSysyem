...
public class UserUpdateInfo extends JFrame
{
	...
	public UserUpdateInfo()
	{
		...
		labelDateBirth.setBounds(150,330,80,80);
		add(labelDateBirth);
		labelDateBirth.setText(""+day+"/"+month+"/"+year);*/
				...
				public void actionPerformed(ActionEvent e1) 
					{
						    try{
							         ...
							         String query2 ="update user set Name='"+value1+"', Phone='"+value2+"',Address='"+value3+"',Gender='"+value4+"',DOB='"+dateOfBirth+"' where Username='"+txtUname.getText()+"'";
